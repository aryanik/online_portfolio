...
const Education = () => {
  ...
  const entries = [
    {
      icon: <FaGraduationCap className="text-3xl md:text-4xl text-emerald-400" />, 
    ...
    {
      icon: <FaSchool className="text-3xl md:text-4xl text-amber-400" />, 
    ...
    {
      icon: <FaBook className="text-3xl md:text-4xl text-violet-400" />, 
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.h2 
              className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent"
              animate={{
            ...
            <motion.div
              className="w-24 md:w-32 h-1 bg-gradient-to-r from-emerald-400 to-purple-400 mx-auto rounded-full"
              animate={{
                width: [96, 160, 96],
                opacity: [0.5, 1, 0.5]
              }}
          ...
          >
            {/* Desktop Timeline */}
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-emerald-400 via-amber-400 to-violet-400 rounded-full opacity-30" />
            
            {/* Mobile Timeline */}
            <div className="md:hidden absolute left-8 top-0 w-1 h-full bg-gradient-to-b from-emerald-400 via-amber-400 to-violet-400 rounded-full opacity-30" />
            ...
            {entries.map((entry, index) => (
              ...
              >
                ...
                <div className="md:hidden flex items-center w-full">
                  ...
                  >
                    <motion.div
                      className={`relative p-6 rounded-3xl backdrop-blur-sm bg-white/10 border border-white/20 shadow-2xl group cursor-pointer overflow-hidden`}
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h3 className="text-lg md:text-2xl font-bold mb-2 group-hover:text-white transition-colors">
                          {entry.title}
                        </h3>
                        <p className="text-gray-300 mb-2 text-sm md:text-lg">{entry.subtitle}</p>
                        <p className="text-gray-400 italic mb-3 text-sm md:text-base">{entry.period}</p>
                        {entry.detail && (
                          <motion.p 
                            className={`font-semibold text-${entry.color}-400 text-sm md:text-base`}
                ...
                {/* Desktop Layout */}
                <motion.div
                  className={`hidden md:block w-5/12 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}
